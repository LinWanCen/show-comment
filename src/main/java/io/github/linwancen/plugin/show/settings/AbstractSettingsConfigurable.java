...
public class AbstractSettingsConfigurable {
    ...
    static boolean isModified(@NotNull AbstractSettingsState settings, @NotNull AbstractSettingsComponent component,
        ...
        modified |= !component.getLineEndDocCount().equals(String.valueOf(settings.lineEndDocCount));
        ...
        modified |= !component.getAnnoDocTree().equals(settings.getAnnoDocTree());
        modified |= !component.getAnnoDocLine().equals(settings.getAnnoDocLine());
    ...
    static void apply(@NotNull AbstractSettingsState settings, @NotNull AbstractSettingsComponent component) {
        ...
        try {
            settings.lineEndDocCount = Integer.parseInt(component.getLineEndDocCount());
        } catch (NumberFormatException e) {
            component.setLineEndDocCount(String.valueOf(settings.lineEndDocCount));
        }
        ...
        settings.setAnnoDocTree(component.getAnnoDocTree());
        settings.setAnnoDocLine(component.getAnnoDocLine());
    ...
    static void reset(@NotNull AbstractSettingsState settings, @NotNull AbstractSettingsComponent component) {
        ...
        component.setAnnoDocTree(settings.getAnnoDocTree());
        component.setAnnoDocLine(settings.getAnnoDocLine());
